...
export const LoggedOut: Story = {
  decorators: [withProviders(currentUserFixtures.notLoggedIn, systemInfoFixtures.showingNeither)],
};

export const LoggedIn: Story = {
  decorators: [withProviders(currentUserFixtures.userOnly, systemInfoFixtures.showingNeither)],
};

export const AdminUser: Story = {
  decorators: [withProviders(currentUserFixtures.adminUser, systemInfoFixtures.showingNeither)],
};
